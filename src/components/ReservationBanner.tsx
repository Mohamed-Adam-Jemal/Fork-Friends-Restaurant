...
export default function ReservationBanner({
  ...
  href = "/reservation",
  backgroundImage = "/images/bg-reservation.jpg", // Customize this path
}) {
  return (
    <section
    ...
    >
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-black/30 backdrop-blur-[3px]" aria-hidden="true" />
        ...
        <Link href={href} passHref>
          <button
            className="
              ...
              before:absolute before:inset-0 before:rounded-2xl before:bg-white/5 before:opacity-0 hover:before:opacity-10 cursor-pointer
            "
          >
